...
const { Admin_GetAllOrder,Admin_AllOrder, Admin_GetOrder, Admin_DelOrder ,Admin_AssignTask } = require("../controllers/adminOrder");
...
// Put Request || update  a particular order
router.put('/update/order/:id',authMiddleware, Admin_AssignTask);
